...
if ! $(noroot wp core is-installed); then
  ...
  noroot git clone --quiet ${VIP_REPO} ${VVV_PATH_TO_SITE}/public_html/wp-content

  echo "VIP: Installing VIP Go mu-plugins..."
  noroot git clone --quiet git@github.com:Automattic/vip-go-mu-plugins.git --recursive ${VVV_PATH_TO_SITE}/public_html/wp-content/mu-plugins/
